...
백엔드 API 개발부터 실시간 데이터 파이프라인(Flink CDC), Kubernetes 플랫폼 운영까지 end-to-end로 직접 설계하고 운영한 경험이 있는 백엔드 개발자입니다. 공용 라이브러리 설계, 오픈소스 커스텀, 성능 최적화 등 팀의 기술적 난제를 주도적으로 해결해 왔으며, 배운 것을 사내 기술 공유와 외부 발표로 적극적으로 환원합니다.

📎 [포트폴리오](https://www.notion.so/328e2d0a976a8037b81ec37660f05a2a) · ✉️ 0108dlatnqls@gmail.com
